...
from reconstructionOptimizer import ReconstructionOptimizer
from utils import *

def main(scripts_path, dataset_folder, gt_name, gt_past_frames, delta_u_list, rendered_imgs_folder, result_folder, para_init, learning_rate = 3e-2, max_iterations = 2500):
    '''
    ...
    ###========================================================
    ### 2) VARIABLES FOR BEZIER CURVE RECONSTRUCTION
    ###========================================================
    ...
    image_save_path_list = [folder_path + filename for filename in gt_past_frames]

    past_frames_list = []
    for path in image_save_path_list:
        past_frames_list.append(process_image(path))

    delta_u_list = torch.tensor(delta_u_list)
    ...
    convergence_window_size = 10 # 50
    convergence_threshold = 1e-3 # 1e-3, 5e-2, 1e-1
    ...
    for loop_id in loop:
        ...
        # Format: [p_start, p_1, p_end]
        if loop_id % 100 == 0 and loop_id != 0:
            filename = f"bezier_params_{loop_id}.npy"
            full_path = scripts_path + '/' + result_folder + '/' + filename
            para = catheter_optimize_model.para_init.data.cpu().numpy().reshape(2, 3)
            para_save = np.vstack((p_start.numpy(), para))
            np.save(full_path, para_save)
            
        loss_queue.append(loss.item())

        # Check for convergence
        if loop_id > 200 and len(loss_queue) == convergence_window_size:
    ...
    plot_3D_bezier_curve(control_points, control_points_gt, control_points_init, full_path, equal=False)
    ...
    full_path = scripts_path + '/' + result_folder + '/' + "motion_model_loss.png"
    plot_motion_model_loss(loss_motion_model_history, full_path, log_scale=True)
...
# gt_past_frames = ['gt_4_0.0006_-0.0006_0.2_0.01.png', 'gt_2_0.0006_-0.0002_0.2_0.01.png']
# delta_u_list = [[0, -0.0004], [0, -0.0004]]

# para_init = np.array([0.034, -0.01, 0.536, 0.2, -0.37, 0.6], dtype=np.float32)
...
# case 1, bad convergence
# gt_name = 'gt_35_-0.0008_0.0008_0.2_0.01'
# gt_past_frames = ['gt_33_-0.0008_0.0004_0.2_0.01.png', 'gt_31_-0.0008_0.0000_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# para_init = np.array([0.02, -0.01, 0.436, -0.19, 0.13, 0.63], dtype=np.float32)

# case 2, good convergence, with careful choice of learning rate and convergence threshold
# gt_name = 'gt_11_-0.0012_0.0008_0.2_0.01'
# para_init = np.array([0.02, -0.01, 0.406, -0.19, 0.18, 0.65], dtype=np.float32)
# gt_past_frames = ['gt_9_-0.0012_0.0004_0.2_0.01.png', 'gt_7_-0.0012_0.0000_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 5e-2

# case 3, average convergence
# gt_name = 'gt_19_-0.0010_0.0000_0.2_0.01'
# para_init = np.array([-0.026, -0.012, 0.517, -0.240, -0.019, 0.974], dtype=np.float32)
# gt_past_frames = ['gt_17_-0.0010_-0.0004_0.2_0.01.png', 'gt_15_-0.0010_-0.0008_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 5e-4

# case 4, good convergence
...
# gt_past_frames = ['gt_22_-0.0010_0.0006_0.2_0.01.png', 'gt_20_-0.0010_0.0002_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 3e-2

# case 5, above average convergence
...
# gt_past_frames = ['gt_28_-0.0008_-0.0006_0.2_0.01.png', 'gt_26_-0.0008_-0.0010_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 3e-3

# case 6, good convergence
# gt_name = 'gt_35_-0.0008_0.0008_0.2_0.01'
...
# case 7, above average convergence
...
# gt_past_frames = ['gt_40_-0.0006_-0.0006_0.2_0.01.png', 'gt_38_-0.0006_-0.0010_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 1e-3

# case 8, average convergence
...
# gt_past_frames = ['gt_142_0.0010_0.0006_0.2_0.01.png', 'gt_141_0.0010_0.0004_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0002]]
# learning_rate = 1e-2

# case 9, good convergence
...
# gt_past_frames = ['gt_136_0.0010_-0.0006_0.2_0.01.png', 'gt_134_0.0010_-0.0010_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 5e-3

# case 10, bad convergence
...
# gt_past_frames = ['gt_114_0.0006_-0.0002_0.2_0.01.png', 'gt_112_0.0006_-0.0006_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 5e-3

# case 11, good convergence
...
# gt_past_frames = ['gt_112_0.0006_-0.0006_0.2_0.01.png', 'gt_110_0.0006_-0.0010_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 1e-3

# case 12, good convergence
...
# gt_past_frames = ['gt_75_0.0000_-0.0008_0.2_0.01.png', 'gt_74_0.0000_-0.0010_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0002]]
# learning_rate = 1e-3

# case 13, average convergence
...
# gt_past_frames = ['gt_66_-0.0002_-0.0002_0.2_0.01.png', 'gt_64_-0.0002_-0.0006_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 5e-4

# case 14, good convergence
...
# gt_past_frames = ['gt_58_-0.0004_0.0006_0.2_0.01.png', 'gt_56_-0.0004_0.0002_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 1e-3

# case 15, average convergence
...
# gt_past_frames = ['gt_53_-0.0004_-0.0004_0.2_0.01.png', 'gt_51_-0.0004_-0.0008_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 1e-3
...
# gt_past_frames = ['gt_87_0.0002_-0.0008_0.2_0.01.png', 'gt_86_0.0002_-0.0010_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0002]]
# learning_rate = 5e-3

# case 17, above average convergence
...
# gt_past_frames = ['gt_99_0.0004_-0.0008_0.2_0.01.png', 'gt_98_0.0004_-0.0010_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0002]]
# learning_rate = 2e-3

# case 18, average convergence
...
# gt_past_frames = ['gt_106_0.0004_0.0006_0.2_0.01.png', 'gt_108_0.0004_0.0010_0.2_0.01.png']
# delta_u_list = [[0, -0.0004], [0, -0.0004]]
# learning_rate = 2e-3

# case 19, above average convergence
...
# gt_past_frames = ['gt_112_0.0006_-0.0006_0.2_0.01.png', 'gt_114_0.0006_-0.0002_0.2_0.01.png']
# delta_u_list = [[0, -0.0004], [0, -0.0004]]
# learning_rate = 2e-3

# case 20, bad convergence
...
# gt_past_frames = ['gt_46_-0.0006_0.0006_0.2_0.01.png', 'gt_44_-0.0006_0.0002_0.2_0.01.png']
# delta_u_list = [[0, 0.0004], [0, 0.0004]]
# learning_rate = 2e-3

# case 21, good convergence
...
gt_past_frames = ['gt_4_-0.0012_-0.0006_0.2_0.01.png', 'gt_2_-0.0012_-0.0010_0.2_0.01.png']
delta_u_list = [[0, 0.0004], [0, 0.0004]]
learning_rate = 2e-3
...
main(scripts_path, dataset_folder, gt_name, gt_past_frames, delta_u_list, rendered_imgs_folder, result_folder, para_init, learning_rate=learning_rate)
