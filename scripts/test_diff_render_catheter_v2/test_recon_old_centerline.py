...
from test_loss_define_v2 import ContourChamferLoss, TipDistanceLoss, \
    CenterlineLoss, GenerateRefData
...
result_folder = f"test_imgs/results_old_centerline_{test_idx}"
...
class CatheterOptimizeModel(nn.Module): 
    ...
    def forward(self, save_img_path): 
        ...
        loss = loss_centerline * weight[0] + loss_tip_distance * weight[1]
