...
n_iter = 10 # 20
n_data = 3 # 100
ux_init = 0.0005 # 0.0005
uy_init = 0.0005 # 0.0005
l_init = 0.2

### Noise parameters
u_noise_percentage = 0.05
cc_to_bezier_noise = 0.005 # 0.002, 0.01
feedback_u_noise_percentage = 0.1 # 0.05
# noise: 0.05, 0.002, lr: 4e-3, 1e-3, 1e-3 
...
data_gen.set_target_ranges(0.0005, 0.005, 0.0005, 0.005, 0.2, 0.2)
