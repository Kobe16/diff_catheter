...
for i in range(4):
    ...
    ref_2d_skeleton_path = mask_4k_loss_path + 'frame_' + str(frame_id[i]) + '/ref_2d_skeleton_frame_' + str(frame_id[i]) + '.npy'
    ...
    img_render_binary_path = mask_4k_loss_path + 'frame_' + str(frame_id[i]) + '/render_final_frame_' + str(frame_id[i]) + '.png'
