...
class DoDiffOptimization(nn.Module):
    ...
    def savingStepFigures(self, save_img_path):
        ...
        ax[1].imshow(self.diff_model.img_render_diffable, cmap=colormap, norm=colormap_norm)
        ax[1].set_title('render mask')
    ...
    def savingFinalStepFigures(self, save_img_path):
        ...
        ax[2].imshow(self.diff_model.img_render_centerline, cmap=colormap, norm=colormap_norm)
        ax[2].set_title('Centerline')

        ax[3].imshow(self.diff_model.img_render_diffable, cmap=colormap, norm=colormap_norm)
        ax[3].set_title('Keypoints')
        ax[3].plot(np.asarray([self.diff_model.bezier_proj_img_npy[0, 0], self.diff_model.pt_intesection_endpoints_render[0]]),
    ...
    def savingReferenceFigures(self, save_img_path):
        ...
        ax[0].set_title('Mask Binarization')
        ...
        ax[2].plot(np.asarray([self.diff_model.ref_skeleton[0, 0], self.diff_model.pt_intesection_endpoints_ref[0]]),
    ...
    def doOptimization(self):
        ...
        while self.id_iteration < self.total_itr_steps:
            ...
            loss_history.append(last_loss.cpu().detach().numpy())
...
if __name__ == '__main__':
    ...
    centerline_gt = np.load(sim_case + 'position_data.npy')
    ...
    # (pt0, pt1, pt2) = dataset.get_initial_guess_quadratic_bezier()
