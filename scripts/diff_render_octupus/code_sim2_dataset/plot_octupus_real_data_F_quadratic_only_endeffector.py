...
for i in range(4, 8):
    ...
    img_mask_4k_path = mask_4k_final_img + 'frame_' + str(frame_id[i - 4]) + '/render_final_frame_' + str(frame_id[i - 4]) + '.png'
    img_render_final_frame = cv2.imread(img_mask_4k_path)
...
for i in range(8, 12):
    ...
    img_mask_4k_path = mask_4k_final_img + 'frame_' + str(frame_id[i - 9]) + '/render_final_frame_' + str(frame_id[i - 9]) + '.png'
    img_render_final_frame = cv2.imread(img_mask_4k_path)
...
for i in range(12, 16):
    ...
    img_mask_4k_path = mask_4k_final_img + 'frame_' + str(frame_id[i - 12]) + '/render_final_frame_' + str(frame_id[i - 12]) + '.png'
    img_render_final_frame = cv2.imread(img_mask_4k_path)
